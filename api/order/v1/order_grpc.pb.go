...
type OrderClient interface {
	...
	GetListOrder(ctx context.Context, in *GetListOrderRequest, opts ...grpc.CallOption) (*GetListOrderReply, error)
}
...
func (c *orderClient) GetListOrder(ctx context.Context, in *GetListOrderRequest, opts ...grpc.CallOption) (*GetListOrderReply, error) {
	out := new(GetListOrderReply)
	err := c.cc.Invoke(ctx, "/api.order.v1.Order/GetListOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrderServer) GetListOrder(context.Context, *GetListOrderRequest) (*GetListOrderReply, error) {
...
func _Order_GetListOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetListOrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).GetListOrder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.order.v1.Order/GetListOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).GetListOrder(ctx, req.(*GetListOrderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Order_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Order_GetListOrder_Handler,
		},
	},
